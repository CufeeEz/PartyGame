...
public class BowBattleLocation {
    ...
    public static Location[] setLocationBB(){
        locSpawnBowBattle[0] = new Location(SpawnLocation.getWorld(), 40.5, 66.5, 31.5);
        locSpawnBowBattle[1] = new Location(SpawnLocation.getWorld(), 40.5, 66.5, 111.5);
        locSpawnBowBattle[2] = new Location(SpawnLocation.getWorld(), 0.5, 66.5, 71.5);
        locSpawnBowBattle[3] = new Location(SpawnLocation.getWorld(), 80.5, 66.5, 71.5);
        locSpawnBowBattle[4] = new Location(SpawnLocation.getWorld(), 12.5, 66.5, 99.5);
        locSpawnBowBattle[5] = new Location(SpawnLocation.getWorld(), 68.5, 66.5, 43.5);
        locSpawnBowBattle[6] = new Location(SpawnLocation.getWorld(), 68.5, 66.5, 99.5);
        locSpawnBowBattle[7] = new Location(SpawnLocation.getWorld(), 12.5, 66.5, 43.5);
